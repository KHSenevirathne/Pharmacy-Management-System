...
public class LoginManager {
    ...
    public Object verifyLogin(String username, String password) {
        try {
            PreparedStatement statement = DatabaseConnection.getInstance().getConnection().prepareStatement("SELECT * FROM `User Detail` WHERE username=? AND CAST(AES_DECRYPT(password,'kaveesh') AS CHAR(100))=?");
